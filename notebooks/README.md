...
The notebooks are written for Colab or Kaggle GPU sessions. They save result and weight ZIP archives at the end of each run. Do not commit the generated weights to Git; their expected names and checksums are listed in `artifacts/README.md`.
